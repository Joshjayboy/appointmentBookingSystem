...
export const GET_FAVORITE_MOVIES_REQUEST = "USER_GET_FAVORITE_MOVIES_REQUEST";
export const GET_FAVORITE_MOVIES_SUCCESS = "USER_GET_FAVORITE_MOVIES_SUCCESS";
export const GET_FAVORITE_MOVIES_FAIL = "USER_GET_FAVORITE_MOVIES_FAIL";
export const GET_FAVORITE_MOVIES_RESET = "USER_GET_FAVORITE_MOVIES_RESET";
